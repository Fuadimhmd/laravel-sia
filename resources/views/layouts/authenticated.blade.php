...
<head>
    ...
    <!-- pnotify-custom css -->
    <link rel="stylesheet" href="{{ asset('/css/plugins/PNotifyBrightTheme.css') }}">
    <!-- prism css -->
...
<body>
    ...
    <script src="{{ asset('/js/jquery-1.4.js') }}"></script>
    <!-- Required Js -->
    ...
    <!-- pnotify Js -->
    <script src="{{ asset('/js/plugins/PNotify.js') }}"></script>
    <script src="{{ asset('/js/plugins/PNotifyButtons.js') }}"></script>
    <script src="{{ asset('/js/plugins/PNotifyCallbacks.js') }}"></script>
    <script src="{{ asset('/js/plugins/PNotifyDesktop.js') }}"></script>
    <script src="{{ asset('/js/plugins/PNotifyConfirm.js') }}"></script>
    <!-- prism Js -->
    ...
    <script type="text/javascript">
        function formatState(state) {
            ...
            var baseUrl = "{{ asset('/images/product/') }}";
            var $state = $(
    ...
    <!-- Ckeditor js -->
    <script src="{{ asset('/js/plugins/ckeditor.js') }}"></script>
    <script type="text/javascript">
