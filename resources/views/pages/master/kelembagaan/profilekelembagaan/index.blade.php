            ...
            <div class="row">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form role="form" action="{{ route('master.profileKelembagaan.update', $profil) }}"
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="npsn"
                                                value="{{ $profil->npsn }}" placeholder="NPSN">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" style="text-transform: uppercase"
                                                name="pemerintahkop" value="{{ $profil->pemerintahkop }}"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="nama_lembaga"
                                                value="{{ $profil->nama_lembaga }}" placeholder="Nama Lembaga">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="form-label font-weight-bolder">LEMBAGA NAUNGAN</label>
                                            <input type="text" class="form-control" name="nama_lembaganaungan"
                                                value="{{ $profil->nama_lembaganaungan }}"
                                                placeholder="Nama Lembaga Naungan">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="notelp"
                                                value="{{ $profil->notelp }}" placeholder="Nomor Telp">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="alamatwebsite"
                                                value="{{ $profil->alamatwebsite }}" placeholder="Alamat Website">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="alamat_lembaga"
                                                value="{{ $profil->alamat_lembaga }}" placeholder="Alamat">
                                        </div>
                                    </div>

                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="kota_lembaga"
                                                value="{{ $profil->kota_lembaga }}" placeholder="Kabupaten / Kota">
                                        </div>
                                    </div>

                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="provinsi_lembaga"
                                                value="{{ $profil->provinsi_lembaga }}" placeholder="Provinsi">
                                        </div>
                                    </div>
                                    ...
                                    <div class="input-group col-md-12">
                                        ...
                                        <textarea class="form-control" name="pesanberjalan" aria-label="With textarea">{{ $profil->pesanberjalan }}</textarea>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="video_profil"
                                                value="{{ $profil->video_profil }}"
                                                placeholder="https://www.youtube.com/embed/yAMcC-d8ciE">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <a class="btn btn-sm btn-primary" data-toggle="collapse"
                                                ...
                                                aria-controls="multiCollapseExample1">Contoh Link Video</a>
                                            <div class="collapse multi-collapse mt-2" id="multiCollapseExample1">
                                                <div class="card">
                                                    <div class="card-body">
                                                        <p class="mb-0">Berikut Contoh:<br><img
                                                                style="width:800px;170px;" src=""
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <div class="card card-info">
                                            <div class="card-header">
                                                <center>
                                                    <h5 class="card-title"><i class="fa fa-hand-o-left"></i> <strong>Ganti
                                                            Logo</strong> </h5>
                                                </center>
                                            </div>
                                ...
                                <button type="submit" class="btn" style="background-color: #037823; color: #ffffff;"
                                    id="pnotify-info"><i class="feather icon-save"></i> Simpan</button>
                            </form>
                        </div>
                ...
                <div class="col-lg-4">
                                ...
                                <div class="media align-items-center">
                                    ...
                                    <div class="media-body">
                                        <p class="mb-0"><i class="feather icon-calendar mr-1"></i><label
                                                class="mb-0"> <?php echo date('d-m-Y'); ?></label></p>
                                    </div>
                                </div>
                            </li>
                            <li class="list-group-item">
                                <div class="media align-items-center">
                                    ...
                                    <div class="media-body">
                                        <p class="mb-0"><i class="feather icon-clock mr-1"></i><label class="mb-0">
                                                <?php echo date('H:i:s'); ?></label></p>
                                    </div>
                                </div>
                            </li>
                        </ul>
                    ...
                    <div class="card hdd-right-inner">
                        ...
                        <div class="card-body">
                            <iframe class="w-100" height="380" src="{{ $profil->video_profil }}"
