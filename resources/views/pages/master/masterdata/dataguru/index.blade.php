                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table id="report-table" class="table table-bordered table-striped mb-0">
                                    ...
                                    <tbody>
                                        @foreach ($dataguru as $no => $res)
                                            <tr>
                                                <td class="text-center">{{ $no + 1 }}</td>
                                                <td>
                                                    <div class="d-inline-block align-middle">
                                                        <div class="card-body">
                                                            <img style="width:75px;75px;"
                                                                src="{{ asset('/storage/upload/fotoguru/' . $res->foto_guru) }}"
                                                                class="img-responsive img-thumbnail" />
                                                            <div class="d-inline-block">
                                                                <h6 class="m-b-0">{{ $res->nama_guru }}</h6>
                                                                <p class="m-b-0">NIP.{{ $res->nip }}</p>
                                                            </div>
                                                        </div>
                                                </td>
                                                <td>
                                                    <div class="d-inline-block align-middle">
                                                        <div class="card-body">
                                                            <p></p>
                                                            <div class="d-inline-block">
                                                                <h6 class="m-b-0"> {{ $res->status_guru }} -
                                                                    {{ $res->golongan }}
                                                                </h6>
                                                                <p class="m-b-0">Guru Mapel : {{ $res->namamapel }}</p>
                                                            </div>
                                                        </div>
                                                </td>
