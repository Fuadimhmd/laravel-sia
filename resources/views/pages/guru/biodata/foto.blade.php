            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form role="form" action="guru/dashboard/updatebiodatafoto" novalidate method="POST"
                                            ...
                                            <div class="card card-info">
                                                <div class="card-body">
                                                    <center><img style="width:150px;150px;"
                                                            src="/storage/upload/fotoguru/<?php echo $data_profil->foto_guru; ?>"
                        ...
                        <ul class="list-group list-group-flush">
                            ...
                            <li class="list-group-item">
                                <div class="media align-items-center">
                                    ...
                                    <div class="media-body">
                                        <p class="mb-0"><i class="feather icon-calendar mr-1"></i><label class="mb-0">
                                                <?php echo date('d-m-Y'); ?></label></p>
                                    </div>
                                </div>
                            </li>
                            <li class="list-group-item">
