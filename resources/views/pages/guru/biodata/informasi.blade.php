            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form role="form" action="guru/dashboard/updatebiodata" novalidate method="POST"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="nama_guru"
                                                value="<?php echo $data_profil->nama_guru; ?>" placeholder="Nama Lengkap">
                                            <input type="hidden" class="form-control" name="id_guru"
                                                value="<?php echo $data_profil->id_guru; ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="nip"
                                                value="<?php echo $data_profil->nip; ?>" placeholder="NIP">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="jeniskelamin" name="jeniskelamin">
                                                <option value="<?php echo $data_profil->jeniskelamin; ?>">Pilihan Saat ini <span
                                                        class="font-weight-bolder">(<?php echo $data_profil->jeniskelamin; ?>)</span></option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="alamat"
                                                value="<?php echo $data_profil->alamat; ?>" placeholder="Alamat Lengkap">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="status_guru" name="status_guru">
                                                <option value="<?php echo $data_profil->status_guru; ?>">Pilihan Saat ini <?php echo $data_profil->status_guru; ?>
                                                </option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="golongan" name="golongan">
                                                <option value="<?php echo $data_profil->golongan; ?>">Pilihan Saat ini <?php echo $data_profil->golongan; ?>
                                                </option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="jenisjabatan" name="jenisjabatan">
                                                <option value="<?php echo $data_profil->jenisjabatan; ?>">Pilihan Saat ini <?php echo $data_profil->jenisjabatan; ?>
                                                </option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="email"
                                                value="<?php echo $data_profil->email; ?>" placeholder="Email">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" name="notelp"
                                                value="<?php echo $data_profil->notelp; ?>" placeholder="No Telp">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="namamapel"
                                                value="<?php echo $data_profil->namamapel; ?>" placeholder="Mengajar Mapel">
                                        </div>
                                    </div>

                                </div>
                                <button type="submit" class="btn btn-info" id="pnotify-info"><i
                                ...
                                <div class="media align-items-center">
                                    ...
                                    <div class="media-body">
                                        <p class="mb-0"><i class="feather icon-mail mr-1"></i><a
                                                href="#"><?php echo $data_profil->email; ?></a></p>
                                    </div>
                                </div>
                            </li>
